...
app.post('/api/summarize', async (req, res) => {
  ...
  const prompt = [
    ...
    'Only summarize what was actually said. Do not add meta phrases like "memory cue", "face card", "speaker gave an update", or "patient can reconnect".',
    'Write 2 to 3 complete, natural sentences, not a fragment, title, label, name, or relationship only.',
    'Each sentence should be direct and on point.',
    ...
    'Example style: "Sarah talked about yesterday\'s walk and mentioned the beautiful trees, flowers, and fresh air. She suggested catching up for another walk someday."',
